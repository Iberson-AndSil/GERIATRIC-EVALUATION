  ...
  const onFinish = async (values: any) => {
    try {
      ...
      api.success({
        ...
        description: 'Los marcadores bioqu├¡micos han sido guardados correctamente.',
        placement: 'topRight',
      });
    } catch (error) {
      api.error({
      ...
      <div className="max-w-[1100px] mx-auto">
        ...
        <div className="text-center mb-8">
          <Title level={3} style={{ color: '#0050b3', margin: 0 }}>
            ...
            MARCADORES BIOQU├ìMICOS CL├ìNICOS
          </Title>
          <Text type="secondary" className="text-lg">Registro de Control Metab├│lico y Renal</Text>
        </div>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* 1. FUNCI├ôN RENAL */}
            <Card 
              title={<span className="text-blue-600 font-bold"><DashboardOutlined className="mr-2"/> FUNCI├ôN RENAL</span>}
            ...
            >
              <Row gutter={16}>
                <Col span={12}>
                  <Form.Item name="albumina" label="Alb├║mina">
                ...
                <Col span={24}>
                  <Form.Item name="proteinas_totales" label="Prote├¡nas Totales">
                    <InputNumber className="w-full" />
                  </Form.Item>
                </Col>
              </Row>
            ...
            <Col span={24} className="p-0">
              <Card 
                title={<span className="text-orange-600 font-bold">METABOLISMO GL├ÜCIDOS Y L├ìPIDOS</span>}
              ...
              >
                <Row gutter={16}>
                  ...
                  <Divider orientation="left" plain>Perfil Lip├¡dico</Divider>
                  <Col xs={12} md={6}>
                  ...
                  <Col xs={12} md={6}>
                    <Form.Item name="trigliceridos" label="Triglic├®ridos"><InputNumber className="w-full" /></Form.Item>
                  </Col>
                </Row>
              </Card>
            </Col>

            {/* 4. INFLAMACI├ôN Y HEMATOLOG├ìA */}
            <Card title="INFLAMACI├ôN CR├ôNICA" className="shadow-sm rounded-xl border-l-4 border-l-red-400">
              <Form.Item name="pcr" label="PCR Cuantitativo">
                <InputNumber className="w-full" />
              </Form.Item>
            </Card>

            <Card title="HEMATOLOG├ìA" className="shadow-sm rounded-xl border-l-4 border-l-purple-400">
              <Row gutter={16}>
                <Col span={12}>
